...
const career = [
  ...
  },
  {
    period: "2018〜2024年",
    area: "金融法人向けコンサル",
    detail: "地方銀行・信用金庫・JA等への資産運用・不動産・年金コンサルや各種アライアンス提携、共同出資、金融機関営業担当者向け資産コンサル、信託商品、年金制度、相続コンサル等に関する研修企画及び講師として登壇など。2022年度社長賞受賞。",
  },
  {
    period: "2024〜2025年",
    area: "投資家事業\n戦略企画推進",
    detail: "国内外金融法人・年金基金・地公体等への戦略企画推進。全国本支店への戦略指導。営業担当者向け各種研修企画及び講師として登壇。",
  },
  {
    period: "2026年〜",
    area: "情報発信",
