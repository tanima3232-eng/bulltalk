      ...
      <main>
        ...
        <section className="bg-navy text-white py-20 px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <a href="#line-url-placeholder" className="btn-line inline-flex items-center gap-3 text-lg px-8 py-4 rounded-xl shadow-lg">
        ...
        <section className="bg-offwhite py-16 px-4">
          <div className="max-w-5xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
              {[1, 2, 3].map((i) => (
                <div key={i} className="bg-gray-200 rounded-xl aspect-video flex items-center justify-center border-2 border-dashed border-gray-300">
                  <div className="text-center text-gray-400">
                    <div className="text-3xl mb-2">▶️</div>
                    <p className="text-sm">YouTube動画<br />（近日追加）</p>
                  </div>
                </div>
              ))}
            </div>
            <div className="text-center">
              <a href="#youtube-channel-placeholder" className="btn-navy px-8 py-3 inline-block">
                YouTubeチャンネルをもっと見る →
              </a>
            </div>
          </div>
