  ...
  return (
    <>
      ...
      <main>
        ...
        >
          ...
          <div className="max-w-2xl mx-auto text-center" style={{position:"relative", zIndex:1}}>
            ...
            <div className="flex flex-col gap-4 mb-10 text-left">
              {[
                { num: "①", title: "毎日の日経225指数の投資判断をLINEで受け取れる", desc: "場引け前に届く、プロの投資判断をリアルタイムで確認。" },
        ...
        <section className="bg-white py-16 px-4">
          <div className="max-w-4xl mx-auto">
            <p className="text-center font-black text-navy mb-8" style={{fontSize:"clamp(1.8rem,5vw,2.8rem)", letterSpacing:"0.1em"}}>初めての方へ</p>
