...
function buildPriorities(checks: Checks, housing: string, insVal: number) {
  ...
  if (checks.hoken && housing==="持ち家（ローンあり）" && checks.loan3) cards.push({ num:"確認事項", highlight:false, title:"生命保険料を見直せる可能性があります。", desc:"住宅ローンで3大疾病特約付き団信に加入している場合、保障が重複しているケースも少なくありません。", note:"※ご自身の保険内容を確認した上で専門家にご相談ください。", style:"green" });
