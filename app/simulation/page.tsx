...
function buildPriorities(checks: Checks, housing: string, insVal: number) {
  ...
  if (checks.hoken && insVal > 0) cards.push({ num:"確認事項", highlight:false, title:"変額保険・積立保険の見直しを検討しましょう", desc:"手数料が高くNISAの非課税メリットを活かせないケースがあります。", note:"※ご加入の保険内容により異なります。専門家への相談を推奨します。", cta:"LINEで保険を一緒に見直す", style:"green", href:"line" });
