...
function buildPriorities(checks: Checks, housing: string, insVal: number) {
  ...
  if (checks.kabu) cards.push({ num:n(idx++), highlight:false, title:"持株会の奨励金を最大活用しましょう", desc:"奨励金率と自社株集中リスクのバランスを確認し、一定割合を売却して分散させることも一般的な考え方です。", cta:"LINEで詳しく相談する", style:"green", href:"line" });
